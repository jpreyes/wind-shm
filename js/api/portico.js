...
import { StaticSolver } from '../solver/static_solver.js?v=178';
...
import { solveBuckling } from '../solver/buckling.js?v=178';
import { StagedSolver } from '../solver/staged.js?v=178';
import { verificarElemento, listDesignCodes, getDesignCode, registerDesignCode } from '../design/diseno.js?v=178';
import { checkDeflection, checkDrift } from '../design/serviceability.js?v=178';
import { polygonProps, compositeProps } from '../design/polygon_props.js?v=178';
import { jointSCWB, strongColumnWeakBeam } from '../design/seismic.js?v=178';
