...
import { backendActive, pushQuality, pullQuality, pushWbs, pushProfile, deleteProtocoloRemote, debouncedPush } from '../core/backend_sync.js?v=333';
import { canQualityApprove } from '../core/auth.js?v=333';
import { t } from '../core/i18n.js?v=333';
...
const GEOMS = {
  ...
  zanja: [['excavacion', 'Excavación'], ['cama', 'Cama arena'], ['ducto', 'Ductos/cable'], ['relleno', 'Relleno'], ['senal', 'Señalización']],
  plataforma: [['despeje', 'Despeje'], ['mejoramiento', 'Mejoramiento'], ['granular', 'Granular'], ['compactacion', 'Compactación']],
};
