...
// ─────────────────────────────────────────────────────────────────────────────
import { CAMAN_CENTER } from './parks_data_caman.js?v=278';
import { CAMAN_ROADS } from './caman_roads.js?v=278';
import { compassRoseSVG } from './compass.js?v=278';
import { annualFlicker, flickerOK, FLICKER_LIMITS, REAL_CASE_FACTOR, flickerMap, criticalWindow, interTurbineShading } from './shadow_flicker.js?v=278';
import { realCaseWeight, METEO_CAMAN } from './meteo_caman.js?v=278';
import { parseReceptorFile } from './receptor_import.js?v=278';
import { t, getLang } from './i18n.js?v=278';
