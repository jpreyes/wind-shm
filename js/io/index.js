...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=191';
export { modelToNeutral, neutralToModel } from './neutral.js?v=191';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=191';
import './formats/abaqus.js?v=191';
import './formats/sap2000.js?v=191';
import './formats/etabs.js?v=191';
import './formats/opensees.js?v=191';
import './formats/sofistik.js?v=191';
