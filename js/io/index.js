...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=189';
export { modelToNeutral, neutralToModel } from './neutral.js?v=189';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=189';
import './formats/abaqus.js?v=189';
import './formats/sap2000.js?v=189';
import './formats/etabs.js?v=189';
// Próximos: OpenSees (.tcl), SOFISTIK (.dat)
