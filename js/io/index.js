...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=195';
export { modelToNeutral, neutralToModel } from './neutral.js?v=195';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=195';
import './formats/abaqus.js?v=195';
import './formats/sap2000.js?v=195';
import './formats/etabs.js?v=195';
import './formats/opensees.js?v=195';
import './formats/sofistik.js?v=195';
