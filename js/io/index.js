...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=209';
export { modelToNeutral, neutralToModel } from './neutral.js?v=209';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=209';
import './formats/abaqus.js?v=209';
import './formats/sap2000.js?v=209';
import './formats/etabs.js?v=209';
import './formats/opensees.js?v=209';
import './formats/sofistik.js?v=209';
