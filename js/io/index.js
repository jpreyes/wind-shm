...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=206';
export { modelToNeutral, neutralToModel } from './neutral.js?v=206';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=206';
import './formats/abaqus.js?v=206';
import './formats/sap2000.js?v=206';
import './formats/etabs.js?v=206';
import './formats/opensees.js?v=206';
import './formats/sofistik.js?v=206';
