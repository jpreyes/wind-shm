...
// ──────────────────────────────────────────────────────────────────────────────
export { registerFormat, getFormat, listFormats, exportModel, importModel } from './registry.js?v=208';
export { modelToNeutral, neutralToModel } from './neutral.js?v=208';

// Adaptadores de formato (auto-registro):
import './formats/vector.js?v=208';
import './formats/abaqus.js?v=208';
import './formats/sap2000.js?v=208';
import './formats/etabs.js?v=208';
import './formats/opensees.js?v=208';
import './formats/sofistik.js?v=208';
