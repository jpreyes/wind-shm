...
} from './timoshenko.js?v=105';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=105';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=105';
