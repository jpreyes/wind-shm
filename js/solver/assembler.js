...
} from './timoshenko.js?v=228';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=228';
import { applyLinkConstraints } from './links.js?v=228';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=228';
