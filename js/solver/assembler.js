...
} from './timoshenko.js?v=327';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=327';
import { applyLinkConstraints } from './links.js?v=327';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=327';
