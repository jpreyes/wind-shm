...
} from './timoshenko.js?v=288';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=288';
import { applyLinkConstraints } from './links.js?v=288';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=288';
