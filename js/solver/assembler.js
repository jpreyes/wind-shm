...
} from './timoshenko.js?v=260';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=260';
import { applyLinkConstraints } from './links.js?v=260';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=260';
