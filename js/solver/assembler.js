...
} from './timoshenko.js?v=172';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=172';
import { applyLinkConstraints } from './links.js?v=172';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=172';
