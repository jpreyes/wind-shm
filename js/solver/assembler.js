...
} from './timoshenko.js?v=86';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=86';
import { assembleAreasInto, areaThermalContribs } from './membrane.js?v=86';
