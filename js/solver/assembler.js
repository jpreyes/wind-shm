...
} from './timoshenko.js?v=117';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=117';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=117';
