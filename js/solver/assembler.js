...
} from './timoshenko.js?v=335';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=335';
import { applyLinkConstraints } from './links.js?v=335';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=335';
