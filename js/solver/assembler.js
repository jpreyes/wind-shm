...
} from './timoshenko.js?v=95';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=95';
import { assembleAreasInto, areaThermalContribs } from './membrane.js?v=95';
