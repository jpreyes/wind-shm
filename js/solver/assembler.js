...
} from './timoshenko.js?v=87';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=87';
import { assembleAreasInto, areaThermalContribs } from './membrane.js?v=87';
