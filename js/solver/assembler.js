...
} from './timoshenko.js?v=272';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=272';
import { applyLinkConstraints } from './links.js?v=272';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=272';
