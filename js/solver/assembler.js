...
} from './timoshenko.js?v=287';
import { applyDiaphragmConstraints, applyDiaphragmMass } from './diaphragm.js?v=287';
import { applyLinkConstraints } from './links.js?v=287';
import { assembleAreasInto, assembleAreasMassInto, areaThermalContribs } from './membrane.js?v=287';
