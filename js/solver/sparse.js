...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=140';
import { applyLinkConstraintsW } from './links.js?v=140';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=140';
