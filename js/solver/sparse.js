...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=155';
import { applyLinkConstraintsW } from './links.js?v=155';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=155';
