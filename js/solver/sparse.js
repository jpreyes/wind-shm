...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=130';
import { applyLinkConstraintsW } from './links.js?v=130';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=130';
