...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=211';
import { applyLinkConstraintsW } from './links.js?v=211';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=211';
