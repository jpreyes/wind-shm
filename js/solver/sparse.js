...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=178';
import { applyLinkConstraintsW } from './links.js?v=178';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=178';
