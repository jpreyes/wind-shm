...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=208';
import { applyLinkConstraintsW } from './links.js?v=208';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=208';
