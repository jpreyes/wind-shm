...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=141';
import { applyLinkConstraintsW } from './links.js?v=141';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=141';
