...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=205';
import { applyLinkConstraintsW } from './links.js?v=205';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=205';
