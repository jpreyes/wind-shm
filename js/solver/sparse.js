...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=176';
import { applyLinkConstraintsW } from './links.js?v=176';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=176';
