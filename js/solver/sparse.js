...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=170';
import { applyLinkConstraintsW } from './links.js?v=170';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=170';
