...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=128';
import { applyLinkConstraintsW } from './links.js?v=128';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=128';
