...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=146';
import { applyLinkConstraintsW } from './links.js?v=146';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=146';
