...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=177';
import { applyLinkConstraintsW } from './links.js?v=177';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=177';
