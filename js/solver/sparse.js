...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=181';
import { applyLinkConstraintsW } from './links.js?v=181';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=181';
