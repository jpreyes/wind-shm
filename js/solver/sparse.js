...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=169';
import { applyLinkConstraintsW } from './links.js?v=169';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=169';
