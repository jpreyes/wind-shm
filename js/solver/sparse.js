...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=172';
import { applyLinkConstraintsW } from './links.js?v=172';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=172';
