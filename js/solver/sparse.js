...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=212';
import { applyLinkConstraintsW } from './links.js?v=212';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=212';
