...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=164';
import { applyLinkConstraintsW } from './links.js?v=164';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=164';
