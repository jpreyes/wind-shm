...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=138';
import { applyLinkConstraintsW } from './links.js?v=138';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=138';
