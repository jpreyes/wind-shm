...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=153';
import { applyLinkConstraintsW } from './links.js?v=153';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=153';
