...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=137';
import { applyLinkConstraintsW } from './links.js?v=137';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=137';
