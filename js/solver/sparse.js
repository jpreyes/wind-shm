...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=200';
import { applyLinkConstraintsW } from './links.js?v=200';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=200';
