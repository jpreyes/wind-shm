...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=144';
import { applyLinkConstraintsW } from './links.js?v=144';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=144';
