...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=166';
import { applyLinkConstraintsW } from './links.js?v=166';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=166';
