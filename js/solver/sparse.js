...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=143';
import { applyLinkConstraintsW } from './links.js?v=143';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=143';
