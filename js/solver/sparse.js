...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=175';
import { applyLinkConstraintsW } from './links.js?v=175';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=175';
