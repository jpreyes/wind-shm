...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=165';
import { applyLinkConstraintsW } from './links.js?v=165';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=165';
