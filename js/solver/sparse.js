...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=156';
import { applyLinkConstraintsW } from './links.js?v=156';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=156';
