...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=195';
import { applyLinkConstraintsW } from './links.js?v=195';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=195';
