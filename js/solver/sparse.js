...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=134';
import { applyLinkConstraintsW } from './links.js?v=134';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=134';
