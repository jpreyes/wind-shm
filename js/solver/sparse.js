...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=136';
import { applyLinkConstraintsW } from './links.js?v=136';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=136';
