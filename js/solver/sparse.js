...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=160';
import { applyLinkConstraintsW } from './links.js?v=160';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=160';
