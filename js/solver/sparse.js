...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=142';
import { applyLinkConstraintsW } from './links.js?v=142';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=142';
