...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=187';
import { applyLinkConstraintsW } from './links.js?v=187';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=187';
