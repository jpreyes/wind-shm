...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=179';
import { applyLinkConstraintsW } from './links.js?v=179';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=179';
