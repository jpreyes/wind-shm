...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=182';
import { applyLinkConstraintsW } from './links.js?v=182';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=182';
