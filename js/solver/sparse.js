...
import { applyDiaphragmConstraintsW, applyDiaphragmMassW } from './diaphragm.js?v=145';
import { applyLinkConstraintsW } from './links.js?v=145';
import { assembleAreasInto, assembleAreasMassInto } from './membrane.js?v=145';
