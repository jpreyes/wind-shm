...
import { createTurbine, TOWER_H } from './turbine_mesh.js?v=334';
import { createSubstationTower, groundCable, overheadLine } from './structures.js?v=334';
import { toScene, CAMAN_CENTER, LAYOUT_SCALE, defaultStages, builtFromStages } from './parks_data_caman.js?v=334';
import { CAMAN_ROADS } from './caman_roads.js?v=334';
import { solarPosition, dateFromLocal, sunSceneDir } from './solar.js?v=334';
...
export class FleetView {
  ...
  async loadTerrain(url) {
    const { Terrain } = await import('./terrain.js?v=334');
