...
import { resolveMaterial, clasificarMaterial } from './material_props.js?v=176';
import { resolveSectionProps } from './section_props.js?v=176';
import { registerDesignCode, getDesignCode, defaultCodeFor, setDefaultCode, listDesignCodes } from './registry.js?v=176';
import { aisc360_lrfd, aisc360_asd } from './codes/aisc360.js?v=176';
import { eurocode3 } from './codes/eurocode3.js?v=176';
import { aci318, eurocode2 } from './codes/concrete.js?v=176';
import { timber_nch1198 } from './codes/timber.js?v=176';
import { eurocode9 } from './codes/eurocode9.js?v=176';
